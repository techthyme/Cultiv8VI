...
const blogPosts = [
  ...
  },
  {
    ...
    href: '#',
    description: 'How Cultiv8VI connects local chefs with farmers to create lasting partnerships that benefit both sides.',
    imageUrl:
      ...
      <main className="isolate">
              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none">
                    We connect local farmers directly with restaurants, bakeries, and food businesses across St. Thomas, St. John, and St. Croix, creating a sustainable farm-to-table ecosystem that supports our community and strengthens local food systems.
                  </p>
                </div>
            ...
            <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                ...
                <p className="mt-10 max-w-xl text-base/7 text-gray-700">
                  ...
                  in the Virgin Islands food system. From small family farms in Cruz Bay to established agricultural operations 
                  in Frederiksted, we provide the digital infrastructure needed to foster direct relationships, fair pricing, 
                  and sustainable business growth across all three major islands.
                </p>
              </div>
                ...
                <dl className="w-64 space-y-8 xl:w-80">
                  {stats.map((stat) => (
                    <div key={stat.label} className="flex flex-col-reverse gap-y-4">
                      ...
                      <dd className="text-5xl font-semibold tracking-tight text-green-600">{stat.value}</dd>
                    </div>
                  ))}
                </dl>
              </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            ...
            <p className="mt-2 text-lg/8 text-gray-600">Learn about sustainable farming and local food systems in the Virgin Islands.</p>
          </div>
      ...
      <footer className="mt-16 sm:mt-32">
        <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
          ...
          <p className="mt-10 text-center text-sm/6 text-gray-600">
            &copy; 2024 Cultiv8VI, Inc. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
